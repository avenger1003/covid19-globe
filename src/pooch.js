(function ()
{
  ...
  var __popup = function (elem)
  {
    ...
    _popupScope.getCovidDetails =  function(csym) {
      ...
      const url = `https://coronavirus-tracker-api.herokuapp.com/v2/locations?country_code=${csym}`;
      Http.open('GET', url);
      Http.send();
      ...
      Http.onreadystatechange = (e)=>{
        ...
        if(response['locations']){
          ...
          <div class="pooch-popup1">
              <div class="pooch-popup1-title">${response['locations'][0].country} </div>
              <div class="pooch-popup1-divider"></div>
              <div class="pooch-popup1-prop">Total confirmed</div>
              <div class="pooch-popup1-val">${response['latest']['confirmed']}</div>
              <div class="pooch-popup1-prop">Total recoverd</div>
              <div class="pooch-popup1-val">${response['latest']['recovered']}</div>
              <div class="pooch-popup1-prop" style="width:80px;">Total deaths</div>
              <div class="pooch-popup1-val" style="width:140px;">${response['latest']['deaths']}</div>
